...
VALUES
    -- Root Admin Users
    (1, 0, NOW(), NOW(), 'The Root Admin', 'root@admin.com', 'Root', 'Admin',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_ROOT_ADMIN'),

    -- Regular Admin Users
    (2, 0, NOW(), NOW(), 'A Regular Admin', 'max@admin.com', 'Max', 'Mustermann',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_ADMIN'),
    (3, 0, NOW(), NOW(), 'A Regular Admin', 'erika@admin.com', 'Erika', 'Mustermann',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_ADMIN'),

    -- Teacher Users
    (4, 0, NOW(), NOW(), 'A DevOps engineer/teacher.', 'thomas@teacher.com', 'Thomas', 'Müller',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_TEACHER'),
    (5, 0, NOW(), NOW(), 'A software development teacher.', 'lina@teacher.com', 'Lina', 'Fischer',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_TEACHER'),
    (6, 0, NOW(), NOW(), 'A science teacher focused on physics and astronomy', 'james@teacher.com', 'James',
     'Wilson', '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_TEACHER'),
    (7, 0, NOW(), NOW(), 'A business teacher with expertise in entrepreneurship and marketing', 'david@teacher.com',
     'David', 'Brown', '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_TEACHER'),
    (8, 0, NOW(), NOW(), 'An engineering teacher focused on mechanical and electrical engineering',
     'michael@teacher.com', 'Michael', 'Johnson', '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u',
     'ROLE_TEACHER'),
    (9, 0, NOW(), NOW(), 'A personal development teacher specializing in leadership and communication',
     'anna@teacher.com', 'Anna', 'Taylor', '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u',
     'ROLE_TEACHER'),
    (10, 0, NOW(), NOW(), 'A design teacher focused on UI/UX and graphic design', 'lucas@teacher.com', 'Lucas',
     'Kim', '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_TEACHER'),
    (11, 0, NOW(), NOW(), 'A health & wellness teacher specializing in nutrition and fitness', 'marcus@teacher.com',
     'Marcus', 'Anderson', '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_TEACHER'),

    -- Student Users
    (12, 0, NOW(), NOW(), NULL, 'hans@hofer.com', 'Hans', 'Hofer',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (13, 0, NOW(), NOW(), NULL, 'sabine@mayer.com', 'Sabine', 'Mayer',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (14, 0, NOW(), NOW(), NULL, 'lukas@wagner.com', 'Lukas', 'Wagner',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (15, 0, NOW(), NOW(), NULL, 'julia@bauer.com', 'Julia', 'Bauer',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (16, 0, NOW(), NOW(), NULL, 'markus@gruber.com', 'Markus', 'Gruber',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (17, 0, NOW(), NOW(), NULL, 'sophia@huber.com', 'Sophia', 'Huber',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (18, 0, NOW(), NOW(), NULL, 'felix@steiner.com', 'Felix', 'Steiner',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (19, 0, NOW(), NOW(), NULL, 'emma@berger.com', 'Emma', 'Berger',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (20, 0, NOW(), NOW(), NULL, 'paul@maier.com', 'Paul', 'Maier',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (21, 0, NOW(), NOW(), NULL, 'laura@wolf.com', 'Laura', 'Wolf',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (22, 0, NOW(), NOW(), NULL, 'simon@weber.com', 'Simon', 'Weber',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (23, 0, NOW(), NOW(), NULL, 'anna@schmid.com', 'Anna', 'Schmid',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (24, 0, NOW(), NOW(), NULL, 'david@schwarz.com', 'David', 'Schwarz',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (25, 0, NOW(), NOW(), NULL, 'sarah@koch.com', 'Sarah', 'Koch',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (26, 0, NOW(), NOW(), NULL, 'max@binder.com', 'Max', 'Binder',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (27, 0, NOW(), NOW(), NULL, 'lisa@fuchs.com', 'Lisa', 'Fuchs',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (28, 0, NOW(), NOW(), NULL, 'thomas@auer.com', 'Thomas', 'Auer',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (29, 0, NOW(), NOW(), NULL, 'nina@winkler.com', 'Nina', 'Winkler',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (30, 0, NOW(), NOW(), NULL, 'christian@moser.com', 'Christian', 'Moser',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (31, 0, NOW(), NOW(), NULL, 'marie@reiter.com', 'Marie', 'Reiter',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),

    -- Disabled Student Users
    (32, 1, NOW(), NOW(), NULL, 'katarina@berg.com', 'Katarina', 'Berg',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (33, 1, NOW(), NOW(), NULL, 'philipp@schneider.com', 'Philipp', 'Schneider',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (34, 1, NOW(), NOW(), NULL, 'sebastian@lang.com', 'Sebastian', 'Lang',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),
    (35, 1, NOW(), NOW(), NULL, 'victoria@keller.com', 'Victoria', 'Keller',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_STUDENT'),

    -- Disabled Teacher Users
    (36, 1, NOW(), NOW(), 'A Mathematics Teacher', 'robert@teacher.com', 'Robert', 'Wagner',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_TEACHER'),
    (37, 1, NOW(), NOW(), 'A Literature Teacher', 'isabel@teacher.com', 'Isabel', 'Hoffmann',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_TEACHER'),
    (38, 1, NOW(), NOW(), 'A Physics Teacher', 'klaus@teacher.com', 'Klaus', 'Schmidt',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_TEACHER'),

    -- Disabled Admin Users
    (39, 1, NOW(), NOW(), 'A Regular Admin', 'stefan@admin.com', 'Stefan', 'Bauer',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_ADMIN'),
    (40, 1, NOW(), NOW(), 'A Regular Admin', 'hannah@admin.com', 'Hannah', 'Weber',
     '$2a$12$9LHpOsnz2RwbioJqCcBGgOHSx9Tn.FfdswODJF.0UzpCOz6VQ0d4u', 'ROLE_ADMIN');
